...
#define SILENT_STEPPER_V2_GPIO_ACTION_EMERGENCY_STOP_RISING_EDGE 4
#define SILENT_STEPPER_V2_GPIO_ACTION_EMERGENCY_STOP_FALLING_EDGE 8
...
#define FID_SET_GPIO_CONFIGURATION 38
#define FID_GET_GPIO_CONFIGURATION 39
