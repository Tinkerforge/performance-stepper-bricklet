 ...
 *
 * config_gpio.h: GPIO input/interrupt configurations
 *
...
#define GPIO_0_INPUT_A      XMC_ERU_ETL_INPUT_A1
#define GPIO_0_INPUT_B      XMC_ERU_ETL_INPUT_B0
#define GPIO_0_TRG_CHANNEL  XMC_ERU_ETL_OUTPUT_TRIGGER_CHANNEL2
#define GPIO_0_SOURCE       XMC_ERU_ETL_SOURCE_A
#define GPIO_0_IRQ_N        5
